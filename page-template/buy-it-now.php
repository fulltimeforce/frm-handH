...
<section class="auction_result-tab">
    <div class="container">
        <div>
            <a href="<?php echo esc_url($still_available_url); ?>" alt="PAST AUCTIONS">PAST AUCTIONS</a>
...
<section class="auction_vehicles">
    <div class="auction_vehicles-container">
        <div class="auction_vehicles-head">
            ...
            <div class="content">
                <p>Vehicles unsold in the most recent auction are promoted here for 14 days post auction, you may make
                    an offer using the provided form below or contact by call us on 01925 210035 or send an email to <a
                        href="mailto:sales@HandH.co.uk">sales@HandH.co.uk</a>.</p>
            </div>
        </div>
