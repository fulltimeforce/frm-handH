			...
			?>
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
						...
						<th scope="row" class="product-name" data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
							...
							echo '<div class="product-info">' . $thumbnail . '<h3>' . $product_name . '</h3></div>';
						...
						<td class="product-remove">
							...
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									'<a role="button" href="%s" class="remove-product" aria-label="%s" data-product_id="%s" data-product_sku="%s">Remove</a>',
