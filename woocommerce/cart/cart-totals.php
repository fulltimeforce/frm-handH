...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<div cellspacing="0" class="table shop_table pricing_table shop_table_responsive">

		<div class="pricing_table-head cart-subtotal label-and-price">
			<p><?php esc_html_e('Sub Total', 'woocommerce'); ?></p>
			<div data-title="<?php esc_attr_e('Sub Total', 'woocommerce'); ?>"><?php wc_cart_totals_subtotal_html(); ?></div>
		</div>

		<div class="pricing_table-body">
		...
		<div class="pricing_table-footer wc-proceed-to-checkout">
			<?php do_action('woocommerce_cart_totals_before_order_total'); ?>
	
			<div class="order-total label-and-price">
				<p><?php esc_html_e('Total', 'woocommerce'); ?></p>
				<div class="total" data-title="<?php esc_attr_e('Total', 'woocommerce'); ?>"><?php wc_cart_totals_order_total_html(); ?></div>
			</div>
