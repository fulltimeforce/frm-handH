...
function general_scripts()
{
    ...
    if (is_page('our-services') || is_page('frequently-asked-questions') || is_page('faq') || is_page('careers') || is_page('insurance') || is_page('get-a-valuation') || is_page('ways-to-bid') || is_singular('vehicles')) {
