                    ...
                    <?php if (!empty($rows)): ?>
                        ...
                        <div class="refine_cards refine_grid">
                            <?php foreach ($rows as $r): ?>
                                <?php hnh_render_vehicle_card((int) $r['vehicle_id'], ['list_context' => $list_context]); ?>
                            <?php endforeach; ?>
                        </div>
                        ...
                        <div class="refine_cards refine_list">
                            <?php foreach ($rows as $r): ?>
                                <?php hnh_render_vehicle_item((int) $r['vehicle_id'], ['list_context' => $list_context]); ?>
                            <?php endforeach; ?>
                        </div>
